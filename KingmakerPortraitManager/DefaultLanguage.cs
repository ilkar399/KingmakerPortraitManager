...
namespace KingmakerPortraitManager
{
    ...
    public class DefaultLanguage: ILanguage
    {
        ...
        public Dictionary<string, string> Strings { get; set; } = new Dictionary<string, string>()
        {
            ...
            { "Menu_PortraitPacks_Btn_Export","Export selected portraits to the Export folder"},
            { "Menu_PortraitPacks_Btn_Import","Import selected portraits from the Import folder"},
            ...
            { "Menu_PortraitPacks_Lbl_ExportHeader","Export: "},
            { "Menu_PortraitPacks_Lbl_ImportHeader","Import: "},
            //TODO
            { "Menu_PortraitPacks_Lbl_ExportHint","Portraits saved to the Exported directory. Portraits to one folder, tags to another."},
            { "Menu_PortraitPacks_Lbl_ImportHint","Don't try without backing up your portrait folder. Portraits are imported to the folder with 'PseudoHash' name instead of the one used in portrait pack"},
